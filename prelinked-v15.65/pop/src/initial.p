...
constant
	popcopyright = 'Copyright (c) 1982-2012 University of Sussex. All rights reserved.',
...
/* --- Revision History ---------------------------------------------------
--- Aaron Sloman, Dec 26 2011
		pop_internal_version = 156500
		Various minor changes, plus alteration to Ved's optimisation for
		dumb terminals.
