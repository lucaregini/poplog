NEWS: 4 May 2012
	mklibpop altered to use -m32 for compiling, to allow 32 bit poplog
	to be rebuilt on 64 bit linux.


NEWS: 26 Dec 2011
	c_core.c altered:
		Change required because of change in format of linux version
		string for linux 3.0 (problem found in Arch linux)
